...
public:
  ...
  bool sendMessage(const String& chat_id, const String& text, const String& parse_mode = "", int message_id = 0, int reply_to_message_id = 0, bool disable_notification = false);
